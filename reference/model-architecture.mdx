---
title: "SSD MobileNet v1 Architecture for License Plate Detection"
sidebarTitle: "Model Architecture"
description: "How DetectorPlacas uses SSD MobileNet v1 for license plate detection: input shapes, tensor names, frozen graph loading, and TF 1.x session-based inference."
---
