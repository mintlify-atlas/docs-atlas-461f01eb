---
title: "pipeline.config Reference for SSD MobileNet v1"
sidebarTitle: "Pipeline Config"
description: "Complete reference for all pipeline.config sections used to train DetectorPlacas: model, anchors, loss, optimizer schedule, and evaluation settings."
---
